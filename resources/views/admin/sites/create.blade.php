    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sites.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('elevation') ? 'is-invalid' : '' }}" type="number" name="elevation" id="elevation" value="{{ old('elevation', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('acreage') ? 'is-invalid' : '' }}" type="number" name="acreage" id="acreage" value="{{ old('acreage', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('settings') ? 'is-invalid' : '' }}" name="settings[]" id="settings" multiple>
                    @foreach($settings as $id => $setting)
                        <option value="{{ $id }}" {{ in_array($id, old('settings', [])) ? 'selected' : '' }}>{{ $setting }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('water_sources') ? 'is-invalid' : '' }}" name="water_sources[]" id="water_sources" multiple>
                    @foreach($water_sources as $id => $water_source)
                        <option value="{{ $id }}" {{ in_array($id, old('water_sources', [])) ? 'selected' : '' }}>{{ $water_source }}</option>
                    @endforeach
                </select>
