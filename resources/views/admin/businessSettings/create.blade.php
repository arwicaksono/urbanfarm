...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.businessSetting.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.business-settings.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('whatsapp') ? 'is-invalid' : '' }}" type="number" name="whatsapp" id="whatsapp" value="{{ old('whatsapp', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telegram') ? 'is-invalid' : '' }}" type="number" name="telegram" id="telegram" value="{{ old('telegram', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reddit') ? 'is-invalid' : '' }}" type="text" name="reddit" id="reddit" value="{{ old('reddit', '') }}">
