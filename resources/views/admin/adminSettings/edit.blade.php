    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.admin-settings.update", [$adminSetting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $adminSetting->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subtitle') ? 'is-invalid' : '' }}" type="text" name="subtitle" id="subtitle" value="{{ old('subtitle', $adminSetting->subtitle) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('copyright') ? 'is-invalid' : '' }}" type="text" name="copyright" id="copyright" value="{{ old('copyright', $adminSetting->copyright) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('dark_mode') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="dark_mode" id="dark_mode" value="1" {{ $adminSetting->dark_mode || old('dark_mode', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('rtl') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="rtl" id="rtl" value="1" {{ $adminSetting->rtl || old('rtl', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $adminSetting->description) !!}</textarea>
