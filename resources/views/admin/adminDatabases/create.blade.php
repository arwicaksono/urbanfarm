...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.adminDatabase.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.admin-databases.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('cause') ? 'is-invalid' : '' }}" name="cause" id="cause">{!! old('cause') !!}</textarea>
                @if($errors->has('cause'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cause') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('prevention') ? 'is-invalid' : '' }}" name="prevention" id="prevention">{!! old('prevention') !!}</textarea>
