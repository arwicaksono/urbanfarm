...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.carePreOrder.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.care-pre-orders.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_delivery') ? 'is-invalid' : '' }}" type="text" name="date_delivery" id="date_delivery" value="{{ old('date_delivery') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('time_delivery') ? 'is-invalid' : '' }}" type="text" name="time_delivery" id="time_delivery" value="{{ old('time_delivery') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('payment') ? 'is-invalid' : '' }}" name="payment" id="payment">
                    ...
                    @foreach(App\Models\CarePreOrder::PAYMENT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('payment', 'no') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
