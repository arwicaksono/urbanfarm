...
class EmployeeApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new EmployeeResource(Employee::with(['employee_name', 'position', 'status', 'team'])->get());
    }
    ...
    public function show(Employee $employee)
    {
        ...
        return new EmployeeResource($employee->load(['employee_name', 'position', 'status', 'team']));
    }
