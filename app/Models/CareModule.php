...
class CareModule extends Model implements HasMedia
{
    use SoftDeletes;
    ...
    public function problem_mo()
    {
        return $this->belongsTo(ModuleObservation::class, 'problem_mo_id');
    }
